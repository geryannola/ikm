...
<h2> Data responden IKM Tahun <?php echo $tahun;?> <?php echo $tw;?></h2>
...
<?php    $no=1;
			...
			$query="select * from user a, matrix b, tbl_pesan c where a.id_s=b.id_s and c.id_s=b.id_s and c.tahun='$tahun' and c.tw='$tw' group by b.id_s";
