<link rel="stylesheet" href="./css/table2.css" type="text/css" media="all" />
<?php 
...
<?php    $no=1;
			...
			$query="select * from tbl_pesan a, matrix b where a.id_s=b.id_s and b.id_kat=$id_kat and a.tahun='$tahun' and a.tw='$tw' group by b.id_s";
...
<!--isi colom tabel dengan nilai hasil query sql di atas-->
                <tr id="col">
					...
					<?php 
					$nilai2=0;
                    $matrix="select * from  matrix  where id_s=$id_s and id_kat=$id_kat";
...
<td>Total</td>
			  ...
			  ?>
                 ...
                 <?php
			  $nsql="select SUM(nilai) AS nrr from matrix a, tbl_pesan b where a.id_p=$id_p and a.id_s=b.id_s and a.id_kat=$id_kat and a.id_kat=b.id_kat and b.tahun='$tahun' and b.tw='$tw' ";
...
<td> Rata-Rata</td>
  <?php  
			  ...
			  ?>
                 ...
                 <?php
			  $nsql="select SUM(nilai) AS nrr from matrix a, tbl_pesan b where a.id_kat=$id_kat and a.id_p=$id_p and  a.id_kat=b.id_kat and a.id_s=b.id_s and b.tahun='$tahun' and b.tw='$tw' ";
			  $nquery=mysql_query($nsql);
			  while($ndata=mysql_fetch_array($nquery)){    
  ...
  <?php  
			  ...
			  while($ndata=mysql_fetch_array($nquery)){    
			   ...
			   $nrx2=number_format($nrx*$nprxz,2);
			    $total+=$nrx2
			   ?>                     
<td><div align="center"><?php echo number_format($nrx*$nprxz,3); ?></div></td>
